...
const int boxySpace[]   = {0x86};      // space does nothing but move over
const int boxyRubout[]  = { lin, 0,10, 6,20, 6,13, lin, 0, 0,12,20, 6,13, lin, 6, 0,12,10, 6,13, 0x8c};
const int boxyExclam[] = {lin,8,8,4,8,0,0,lin,8,20,8,8,0,0,lin,4,20,8,20,0,0,lin,4,8,4,20,0,0,lin,8,0,4,0,0,0,lin,8,4,8,0,0,0,lin,4,4,8,4,0,0,lin,4,0,4,4,0,0,0x8c};
const int boxyDQuot[] = {lin,4,12,0,12,0,0,lin,4,20,4,12,0,0,lin,0,20,4,20,0,0,lin,0,12,0,20,0,0,lin,12,12,8,12,0,0,lin,12,20,12,12,0,0,lin,8,20,12,20,0,0,lin,8,12,8,20,0,0,0x8c};
const int boxySharp[] = {lin,4,0,0,0,0,0,lin,4,4,4,0,0,0,lin,8,4,4,4,0,0,lin,8,0,8,4,0,0,lin,12,0,8,0,0,0,lin,12,20,12,0,0,0,lin,8,20,12,20,0,0,lin,8,16,8,20,0,0,lin,4,16,8,16,0,0,lin,4,20,4,16,0,0,lin,0,20,4,20,0,0,lin,0,0,0,20,0,0,lin,4,8,8,8,0,0,lin,4,12,4,8,0,0,lin,8,12,4,12,0,0,lin,8,8,8,12,0,0,0x8c};
const int boxyDollar[] = {lin,8,0,4,0,0,0,lin,8,4,8,0,0,0,lin,12,4,8,4,0,0,lin,12,12,12,4,0,0,lin,8,12,12,12,0,0,lin,8,16,8,12,0,0,lin,12,16,8,16,0,0,lin,12,20,12,16,0,0,lin,0,20,12,20,0,0,lin,0,12,0,20,0,0,lin,4,12,0,12,0,0,lin,4,8,4,12,0,0,lin,0,8,4,8,0,0,lin,0,4,0,8,0,0,lin,4,4,0,4,0,0,lin,4,0,4,4,0,0,0x8c};
const int boxyPercent[] = {lin,4,16,0,16,0,0,lin,4,20,4,16,0,0,lin,0,20,4,20,0,0,lin,0,16,0,20,0,0,lin,4,0,0,0,0,0,lin,4,8,4,0,0,0,lin,0,8,4,8,0,0,lin,0,0,0,8,0,0,lin,8,8,4,8,0,0,lin,8,12,8,8,0,0,lin,4,12,8,12,0,0,lin,4,8,4,12,0,0,lin,12,12,8,12,0,0,lin,12,20,12,12,0,0,lin,8,20,12,20,0,0,lin,8,12,8,20,0,0,lin,12,0,8,0,0,0,lin,12,4,12,0,0,0,lin,8,4,12,4,0,0,lin,8,0,8,4,0,0,0x8c};
const int boxyAmper[] = {lin,12,0,0,0,0,0,lin,12,12,12,0,0,0,lin,8,12,12,12,0,0,lin,8,20,8,12,0,0,lin,0,20,8,20,0,0,lin,0,0,0,20,0,0,lin,4,4,8,4,0,0,lin,4,8,4,4,0,0,lin,8,8,4,8,0,0,lin,8,4,8,8,0,0,0x8c};
const int boxyApost[] = {lin,4,12,0,12,0,0,lin,4,16,4,12,0,0,lin,0,16,4,16,0,0,lin,0,12,0,16,0,0,lin,8,16,4,16,0,0,lin,8,20,8,16,0,0,lin,4,20,8,20,0,0,lin,4,16,4,20,0,0,0x8c};
const int boxyLParen[] = {lin,4,4,0,4,0,0,lin,4,16,4,4,0,0,lin,0,16,4,16,0,0,lin,0,4,0,16,0,0,lin,8,16,4,16,0,0,lin,8,20,8,16,0,0,lin,4,20,8,20,0,0,lin,4,16,4,20,0,0,lin,8,0,4,0,0,0,lin,8,4,8,0,0,0,lin,4,4,8,4,0,0,lin,4,0,4,4,0,0,0x8c};
const int boxyRParen[] = {lin,8,16,4,16,0,0,lin,8,20,8,16,0,0,lin,4,20,8,20,0,0,lin,4,16,4,20,0,0,lin,8,0,4,0,0,0,lin,8,4,8,0,0,0,lin,4,4,8,4,0,0,lin,4,0,4,4,0,0,lin,12,4,8,4,0,0,lin,12,16,12,4,0,0,lin,8,16,12,16,0,0,lin,8,4,8,16,0,0,0x8c};
const int boxyAster[] = {lin,4,16,0,16,0,0,lin,4,20,4,16,0,0,lin,0,20,4,20,0,0,lin,0,16,0,20,0,0,lin,8,4,4,4,0,0,lin,8,8,8,4,0,0,lin,12,8,8,8,0,0,lin,12,12,12,8,0,0,lin,8,12,12,12,0,0,lin,8,16,8,12,0,0,lin,4,16,8,16,0,0,lin,4,12,4,16,0,0,lin,0,12,4,12,0,0,lin,0,8,0,12,0,0,lin,4,8,0,8,0,0,lin,4,4,4,8,0,0,lin,4,0,0,0,0,0,lin,4,4,4,0,0,0,lin,0,4,4,4,0,0,lin,0,0,0,4,0,0,lin,12,16,8,16,0,0,lin,12,20,12,16,0,0,lin,8,20,12,20,0,0,lin,8,16,8,20,0,0,lin,12,0,8,0,0,0,lin,12,4,12,0,0,0,lin,8,4,12,4,0,0,lin,8,0,8,4,0,0,0x8c};
const int boxyPlus[] = {lin,8,4,4,4,0,0,lin,8,8,8,4,0,0,lin,12,8,8,8,0,0,lin,12,12,12,8,0,0,lin,8,12,12,12,0,0,lin,8,16,8,12,0,0,lin,4,16,8,16,0,0,lin,4,12,4,16,0,0,lin,0,12,4,12,0,0,lin,0,8,0,12,0,0,lin,4,8,0,8,0,0,lin,4,4,4,8,0,0,0x8c};
const int boxyComma[] = {lin,4,0,0,0,0,0,lin,4,4,4,0,0,0,lin,0,4,4,4,0,0,lin,0,0,0,4,0,0,lin,8,4,4,4,0,0,lin,8,8,8,4,0,0,lin,4,8,8,8,0,0,lin,4,4,4,8,0,0,0x8c};
const int boxyMinus[] = {lin,12,8,0,8,0,0,lin,12,12,12,8,0,0,lin,0,12,12,12,0,0,lin,0,8,0,12,0,0,0x8c};
const int boxyPeriod[] = {lin,8,0,4,0,0,0,lin,8,4,8,0,0,0,lin,4,4,8,4,0,0,lin,4,0,4,4,0,0,0x8c};
const int boxySlash[] = {lin,4,0,0,0,0,0,lin,4,4,4,0,0,0,lin,0,4,4,4,0,0,lin,0,0,0,4,0,0,lin,8,4,4,4,0,0,lin,8,16,8,4,0,0,lin,4,16,8,16,0,0,lin,4,4,4,16,0,0,lin,12,16,8,16,0,0,lin,12,20,12,16,0,0,lin,8,20,12,20,0,0,lin,8,16,8,20,0,0,0x8c};
const int boxyZero[] = {lin,12,0,0,0,0,0,lin,12,20,12,0,0,0,lin,0,20,12,20,0,0,lin,0,0,0,20,0,0,lin,4,4,8,4,0,0,lin,4,16,4,4,0,0,lin,8,16,4,16,0,0,lin,8,4,8,16,0,0,0x8c};
const int boxyOne[] = {lin,12,0,0,0,0,0,lin,12,4,12,0,0,0,lin,8,4,12,4,0,0,lin,8,20,8,4,0,0,lin,0,20,8,20,0,0,lin,0,16,0,20,0,0,lin,4,16,0,16,0,0,lin,4,4,4,16,0,0,lin,0,4,4,4,0,0,lin,0,0,0,4,0,0,0x8c};
const int boxyTwo[] = {lin,12,0,0,0,0,0,lin,12,4,12,0,0,0,lin,4,4,12,4,0,0,lin,4,8,4,4,0,0,lin,12,8,4,8,0,0,lin,12,20,12,8,0,0,lin,0,20,12,20,0,0,lin,0,16,0,20,0,0,lin,8,16,0,16,0,0,lin,8,12,8,16,0,0,lin,0,12,8,12,0,0,lin,0,0,0,12,0,0,0x8c};
const int boxyThree[] = {lin,12,0,0,0,0,0,lin,12,20,12,0,0,0,lin,0,20,12,20,0,0,lin,0,16,0,20,0,0,lin,8,16,0,16,0,0,lin,8,12,8,16,0,0,lin,4,12,8,12,0,0,lin,4,8,4,12,0,0,lin,8,8,4,8,0,0,lin,8,4,8,8,0,0,lin,0,4,8,4,0,0,lin,0,0,0,4,0,0,0x8c};
const int boxyFour[] = {lin,12,0,8,0,0,0,lin,12,20,12,0,0,0,lin,8,20,12,20,0,0,lin,8,12,8,20,0,0,lin,4,12,8,12,0,0,lin,4,20,4,12,0,0,lin,0,20,4,20,0,0,lin,0,8,0,20,0,0,lin,8,8,0,8,0,0,lin,8,0,8,8,0,0,0x8c};
const int boxyFive[] = {lin,12,0,0,0,0,0,lin,12,12,12,0,0,0,lin,4,12,12,12,0,0,lin,4,16,4,12,0,0,lin,12,16,4,16,0,0,lin,12,20,12,16,0,0,lin,0,20,12,20,0,0,lin,0,8,0,20,0,0,lin,8,8,0,8,0,0,lin,8,4,8,8,0,0,lin,0,4,8,4,0,0,lin,0,0,0,4,0,0,0x8c};
const int boxySix[] = {lin,12,0,0,0,0,0,lin,12,12,12,0,0,0,lin,4,12,12,12,0,0,lin,4,20,4,12,0,0,lin,0,20,4,20,0,0,lin,0,0,0,20,0,0,lin,4,4,8,4,0,0,lin,4,8,4,4,0,0,lin,8,8,4,8,0,0,lin,8,4,8,8,0,0,0x8c};
const int boxySeven[] = {lin,12,0,8,0,0,0,lin,12,20,12,0,0,0,lin,0,20,12,20,0,0,lin,0,16,0,20,0,0,lin,8,16,0,16,0,0,lin,8,0,8,16,0,0,0x8c};
const int boxyEight[] = {lin,12,0,0,0,0,0,lin,12,20,12,0,0,0,lin,0,20,12,20,0,0,lin,0,0,0,20,0,0,lin,4,12,8,12,0,0,lin,4,16,4,12,0,0,lin,8,16,4,16,0,0,lin,8,12,8,16,0,0,lin,4,4,8,4,0,0,lin,4,8,4,4,0,0,lin,8,8,4,8,0,0,lin,8,4,8,8,0,0,0x8c};
const int boxyNine[] = {lin,12,0,8,0,0,0,lin,12,20,12,0,0,0,lin,0,20,12,20,0,0,lin,0,8,0,20,0,0,lin,8,8,0,8,0,0,lin,8,0,8,8,0,0,lin,4,12,8,12,0,0,lin,4,16,4,12,0,0,lin,8,16,4,16,0,0,lin,8,12,8,16,0,0,0x8c};
const int boxyColon[] = {lin,8,12,4,12,0,0,lin,8,16,8,12,0,0,lin,4,16,8,16,0,0,lin,4,12,4,16,0,0,lin,8,4,4,4,0,0,lin,8,8,8,4,0,0,lin,4,8,8,8,0,0,lin,4,4,4,8,0,0,0x8c};
const int boxySemiCol[] = {lin,4,0,0,0,0,0,lin,4,4,4,0,0,0,lin,0,4,4,4,0,0,lin,0,0,0,4,0,0,lin,8,12,4,12,0,0,lin,8,16,8,12,0,0,lin,4,16,8,16,0,0,lin,4,12,4,16,0,0,lin,8,4,4,4,0,0,lin,8,8,8,4,0,0,lin,4,8,8,8,0,0,lin,4,4,4,8,0,0,0x8c};
const int boxyLThan[] = {lin,4,8,0,8,0,0,lin,4,12,4,8,0,0,lin,0,12,4,12,0,0,lin,0,8,0,12,0,0,lin,8,12,4,12,0,0,lin,8,16,8,12,0,0,lin,4,16,8,16,0,0,lin,4,12,4,16,0,0,lin,8,4,4,4,0,0,lin,8,8,8,4,0,0,lin,4,8,8,8,0,0,lin,4,4,4,8,0,0,lin,12,16,8,16,0,0,lin,12,20,12,16,0,0,lin,8,20,12,20,0,0,lin,8,16,8,20,0,0,lin,12,0,8,0,0,0,lin,12,4,12,0,0,0,lin,8,4,12,4,0,0,lin,8,0,8,4,0,0,0x8c};
const int boxyEqual[] = {lin,12,12,0,12,0,0,lin,12,16,12,12,0,0,lin,0,16,12,16,0,0,lin,0,12,0,16,0,0,lin,12,4,0,4,0,0,lin,12,8,12,4,0,0,lin,0,8,12,8,0,0,lin,0,4,0,8,0,0,0x8c};
const int boxyGThan[] = {lin,4,16,0,16,0,0,lin,4,20,4,16,0,0,lin,0,20,4,20,0,0,lin,0,16,0,20,0,0,lin,4,0,0,0,0,0,lin,4,4,4,0,0,0,lin,0,4,4,4,0,0,lin,0,0,0,4,0,0,lin,8,12,4,12,0,0,lin,8,16,8,12,0,0,lin,4,16,8,16,0,0,lin,4,12,4,16,0,0,lin,8,4,4,4,0,0,lin,8,8,8,4,0,0,lin,4,8,8,8,0,0,lin,4,4,4,8,0,0,lin,12,8,8,8,0,0,lin,12,12,12,8,0,0,lin,8,12,12,12,0,0,lin,8,8,8,12,0,0,0x8c};
const int boxyQuest[] = {lin,12,8,4,8,0,0,lin,12,20,12,8,0,0,lin,0,20,12,20,0,0,lin,0,16,0,20,0,0,lin,8,16,0,16,0,0,lin,8,12,8,16,0,0,lin,4,12,8,12,0,0,lin,4,8,4,12,0,0,lin,8,0,4,0,0,0,lin,8,4,8,0,0,0,lin,4,4,8,4,0,0,lin,4,0,4,4,0,0,0x8c};
const int boxyAtSign[] = {lin,4,4,0,4,0,0,lin,4,16,4,4,0,0,lin,0,16,4,16,0,0,lin,0,4,0,16,0,0,lin,8,16,4,16,0,0,lin,8,20,8,16,0,0,lin,4,20,8,20,0,0,lin,4,16,4,20,0,0,lin,12,0,4,0,0,0,lin,12,4,12,0,0,0,lin,4,4,12,4,0,0,lin,4,0,4,4,0,0,lin,12,8,8,8,0,0,lin,12,16,12,8,0,0,lin,8,16,12,16,0,0,lin,8,8,8,16,0,0,0x8c};
const int boxyBigA[] = {lin,4,0,0,0,0,0,lin,4,8,4,0,0,0,lin,8,8,4,8,0,0,lin,8,0,8,8,0,0,lin,12,0,8,0,0,0,lin,12,20,12,0,0,0,lin,0,20,12,20,0,0,lin,0,0,0,20,0,0,lin,4,12,8,12,0,0,lin,4,16,4,12,0,0,lin,8,16,4,16,0,0,lin,8,12,8,16,0,0,0x8c};
const int boxyBigB[] = {lin,12,0,0,0,0,0,lin,12,8,12,0,0,0,lin,8,8,12,8,0,0,lin,8,4,8,8,0,0,lin,4,4,8,4,0,0,lin,4,8,4,4,0,0,lin,8,8,4,8,0,0,lin,8,12,8,8,0,0,lin,4,12,8,12,0,0,lin,4,16,4,12,0,0,lin,8,16,4,16,0,0,lin,8,12,8,16,0,0,lin,12,12,8,12,0,0,lin,12,20,12,12,0,0,lin,0,20,12,20,0,0,lin,0,0,0,20,0,0,0x8c};
const int boxyBigC[] = {lin,4,4,0,4,0,0,lin,4,16,4,4,0,0,lin,0,16,4,16,0,0,lin,0,4,0,16,0,0,lin,12,16,4,16,0,0,lin,12,20,12,16,0,0,lin,4,20,12,20,0,0,lin,4,16,4,20,0,0,lin,12,0,4,0,0,0,lin,12,4,12,0,0,0,lin,4,4,12,4,0,0,lin,4,0,4,4,0,0,0x8c};
const int boxyBigD[] = {lin,12,0,0,0,0,0,lin,12,16,12,0,0,0,lin,8,16,12,16,0,0,lin,8,4,8,16,0,0,lin,4,4,8,4,0,0,lin,4,16,4,4,0,0,lin,8,16,4,16,0,0,lin,8,20,8,16,0,0,lin,0,20,8,20,0,0,lin,0,0,0,20,0,0,0x8c};
const int boxyBigE[] = {lin,12,0,0,0,0,0,lin,12,4,12,0,0,0,lin,4,4,12,4,0,0,lin,4,8,4,4,0,0,lin,8,8,4,8,0,0,lin,8,12,8,8,0,0,lin,4,12,8,12,0,0,lin,4,16,4,12,0,0,lin,12,16,4,16,0,0,lin,12,20,12,16,0,0,lin,0,20,12,20,0,0,lin,0,0,0,20,0,0,0x8c};
const int boxyBigF[] = {lin,4,0,0,0,0,0,lin,4,8,4,0,0,0,lin,8,8,4,8,0,0,lin,8,12,8,8,0,0,lin,4,12,8,12,0,0,lin,4,16,4,12,0,0,lin,12,16,4,16,0,0,lin,12,20,12,16,0,0,lin,0,20,12,20,0,0,lin,0,0,0,20,0,0,0x8c};
const int boxyBigG[] = {lin,12,0,0,0,0,0,lin,12,8,12,0,0,0,lin,8,8,12,8,0,0,lin,8,4,8,8,0,0,lin,4,4,8,4,0,0,lin,4,16,4,4,0,0,lin,0,16,4,16,0,0,lin,0,0,0,16,0,0,lin,12,16,4,16,0,0,lin,12,20,12,16,0,0,lin,4,20,12,20,0,0,lin,4,16,4,20,0,0,0x8c};
const int boxyBigH[] = {lin,4,0,0,0,0,0,lin,4,8,4,0,0,0,lin,8,8,4,8,0,0,lin,8,0,8,8,0,0,lin,12,0,8,0,0,0,lin,12,20,12,0,0,0,lin,8,20,12,20,0,0,lin,8,12,8,20,0,0,lin,4,12,8,12,0,0,lin,4,20,4,12,0,0,lin,0,20,4,20,0,0,lin,0,0,0,20,0,0,0x8c};
const int boxyBigI[] = {lin,12,0,0,0,0,0,lin,12,4,12,0,0,0,lin,8,4,12,4,0,0,lin,8,16,8,4,0,0,lin,12,16,8,16,0,0,lin,12,20,12,16,0,0,lin,0,20,12,20,0,0,lin,0,16,0,20,0,0,lin,4,16,0,16,0,0,lin,4,4,4,16,0,0,lin,0,4,4,4,0,0,lin,0,0,0,4,0,0,0x8c};
const int boxyBigJ[] = {lin,8,0,0,0,0,0,lin,8,16,8,0,0,0,lin,12,16,8,16,0,0,lin,12,20,12,16,0,0,lin,0,20,12,20,0,0,lin,0,16,0,20,0,0,lin,4,16,0,16,0,0,lin,4,4,4,16,0,0,lin,0,4,4,4,0,0,lin,0,0,0,4,0,0,0x8c};
const int boxyBigK[] = {lin,4,0,0,0,0,0,lin,4,8,4,0,0,0,lin,8,8,4,8,0,0,lin,8,12,8,8,0,0,lin,4,12,8,12,0,0,lin,4,20,4,12,0,0,lin,0,20,4,20,0,0,lin,0,0,0,20,0,0,lin,12,12,8,12,0,0,lin,12,20,12,12,0,0,lin,8,20,12,20,0,0,lin,8,12,8,20,0,0,lin,12,0,8,0,0,0,lin,12,8,12,0,0,0,lin,8,8,12,8,0,0,lin,8,0,8,8,0,0,0x8c};
const int boxyBigL[] = {lin,12,0,0,0,0,0,lin,12,4,12,0,0,0,lin,4,4,12,4,0,0,lin,4,20,4,4,0,0,lin,0,20,4,20,0,0,lin,0,0,0,20,0,0,0x8c};
const int boxyBigM[] = {lin,4,0,0,0,0,0,lin,4,12,4,0,0,0,lin,8,12,4,12,0,0,lin,8,0,8,12,0,0,lin,12,0,8,0,0,0,lin,12,20,12,0,0,0,lin,0,20,12,20,0,0,lin,0,0,0,20,0,0,0x8c};
const int boxyBigN[] = {lin,4,0,0,0,0,0,lin,4,16,4,0,0,0,lin,8,16,4,16,0,0,lin,8,20,8,16,0,0,lin,0,20,8,20,0,0,lin,0,0,0,20,0,0,lin,12,0,8,0,0,0,lin,12,16,12,0,0,0,lin,8,16,12,16,0,0,lin,8,0,8,16,0,0,0x8c};
const int boxyBigO[] = {lin,8,0,0,0,0,0,lin,8,4,8,0,0,0,lin,4,4,8,4,0,0,lin,4,16,4,4,0,0,lin,0,16,4,16,0,0,lin,0,0,0,16,0,0,lin,12,4,8,4,0,0,lin,12,20,12,4,0,0,lin,4,20,12,20,0,0,lin,4,16,4,20,0,0,lin,8,16,4,16,0,0,lin,8,4,8,16,0,0,0x8c};
const int boxyBigP[] = {lin,4,0,0,0,0,0,lin,4,8,4,0,0,0,lin,12,8,4,8,0,0,lin,12,20,12,8,0,0,lin,0,20,12,20,0,0,lin,0,0,0,20,0,0,lin,4,12,8,12,0,0,lin,4,16,4,12,0,0,lin,8,16,4,16,0,0,lin,8,12,8,16,0,0,0x8c};
const int boxyBigQ[] = {lin,12,0,4,0,0,0,lin,12,4,12,0,0,0,lin,8,4,12,4,0,0,lin,8,8,8,4,0,0,lin,4,8,8,8,0,0,lin,4,16,4,8,0,0,lin,0,16,4,16,0,0,lin,0,4,0,16,0,0,lin,4,4,0,4,0,0,lin,4,0,4,4,0,0,lin,8,16,4,16,0,0,lin,8,20,8,16,0,0,lin,4,20,8,20,0,0,lin,4,16,4,20,0,0,lin,12,8,8,8,0,0,lin,12,16,12,8,0,0,lin,8,16,12,16,0,0,lin,8,8,8,16,0,0,0x8c};
const int boxyBigR[] = {lin,4,0,0,0,0,0,lin,4,8,4,0,0,0,lin,8,8,4,8,0,0,lin,8,12,8,8,0,0,lin,4,12,8,12,0,0,lin,4,16,4,12,0,0,lin,8,16,4,16,0,0,lin,8,12,8,16,0,0,lin,12,12,8,12,0,0,lin,12,20,12,12,0,0,lin,0,20,12,20,0,0,lin,0,0,0,20,0,0,lin,12,0,8,0,0,0,lin,12,8,12,0,0,0,lin,8,8,12,8,0,0,lin,8,0,8,8,0,0,0x8c};
const int boxyBigS[] = {lin,12,4,8,4,0,0,lin,12,12,12,4,0,0,lin,4,12,12,12,0,0,lin,4,16,4,12,0,0,lin,0,16,4,16,0,0,lin,0,8,0,16,0,0,lin,8,8,0,8,0,0,lin,8,4,8,8,0,0,lin,8,0,0,0,0,0,lin,8,4,8,0,0,0,lin,0,4,8,4,0,0,lin,0,0,0,4,0,0,lin,12,16,4,16,0,0,lin,12,20,12,16,0,0,lin,4,20,12,20,0,0,lin,4,16,4,20,0,0,0x8c};
const int boxyBigT[] = {lin,8,0,4,0,0,0,lin,8,16,8,0,0,0,lin,12,16,8,16,0,0,lin,12,20,12,16,0,0,lin,0,20,12,20,0,0,lin,0,16,0,20,0,0,lin,4,16,0,16,0,0,lin,4,0,4,16,0,0,0x8c};
const int boxyBigU[] = {lin,4,4,0,4,0,0,lin,4,20,4,4,0,0,lin,0,20,4,20,0,0,lin,0,4,0,20,0,0,lin,12,0,4,0,0,0,lin,12,20,12,0,0,0,lin,8,20,12,20,0,0,lin,8,4,8,20,0,0,lin,4,4,8,4,0,0,lin,4,0,4,4,0,0,0x8c};
const int boxyBigV[] = {lin,8,0,4,0,0,0,lin,8,4,8,0,0,0,lin,12,4,8,4,0,0,lin,12,20,12,4,0,0,lin,8,20,12,20,0,0,lin,8,8,8,20,0,0,lin,4,8,8,8,0,0,lin,4,20,4,8,0,0,lin,0,20,4,20,0,0,lin,0,4,0,20,0,0,lin,4,4,0,4,0,0,lin,4,0,4,4,0,0,0x8c};
const int boxyBigW[] = {lin,12,0,0,0,0,0,lin,12,20,12,0,0,0,lin,8,20,12,20,0,0,lin,8,8,8,20,0,0,lin,4,8,8,8,0,0,lin,4,20,4,8,0,0,lin,0,20,4,20,0,0,lin,0,0,0,20,0,0,0x8c};
const int boxyBigX[] = {lin,4,12,0,12,0,0,lin,4,20,4,12,0,0,lin,0,20,4,20,0,0,lin,0,12,0,20,0,0,lin,4,0,0,0,0,0,lin,4,8,4,0,0,0,lin,0,8,4,8,0,0,lin,0,0,0,8,0,0,lin,8,8,4,8,0,0,lin,8,12,8,8,0,0,lin,4,12,8,12,0,0,lin,4,8,4,12,0,0,lin,12,12,8,12,0,0,lin,12,20,12,12,0,0,lin,8,20,12,20,0,0,lin,8,12,8,20,0,0,lin,12,0,8,0,0,0,lin,12,8,12,0,0,0,lin,8,8,12,8,0,0,lin,8,0,8,8,0,0,0x8c};
const int boxyBigY[] = {lin,12,0,0,0,0,0,lin,12,20,12,0,0,0,lin,8,20,12,20,0,0,lin,8,12,8,20,0,0,lin,4,12,8,12,0,0,lin,4,20,4,12,0,0,lin,0,20,4,20,0,0,lin,0,8,0,20,0,0,lin,8,8,0,8,0,0,lin,8,4,8,8,0,0,lin,0,4,8,4,0,0,lin,0,0,0,4,0,0,0x8c};
const int boxyBigZ[] = {lin,12,12,8,12,0,0,lin,12,20,12,12,0,0,lin,0,20,12,20,0,0,lin,0,16,0,20,0,0,lin,8,16,0,16,0,0,lin,8,12,8,16,0,0,lin,12,0,0,0,0,0,lin,12,4,12,0,0,0,lin,4,4,12,4,0,0,lin,4,8,4,4,0,0,lin,0,8,4,8,0,0,lin,0,0,0,8,0,0,lin,8,8,4,8,0,0,lin,8,12,8,8,0,0,lin,4,12,8,12,0,0,lin,4,8,4,12,0,0,0x8c};
const int boxyLftSqBr[] = {lin,8,0,0,0,0,0,lin,8,4,8,0,0,0,lin,4,4,8,4,0,0,lin,4,16,4,4,0,0,lin,8,16,4,16,0,0,lin,8,20,8,16,0,0,lin,0,20,8,20,0,0,lin,0,0,0,20,0,0,0x8c};
const int boxyBackSl[] = {lin,4,16,0,16,0,0,lin,4,20,4,16,0,0,lin,0,20,4,20,0,0,lin,0,16,0,20,0,0,lin,8,4,4,4,0,0,lin,8,16,8,4,0,0,lin,4,16,8,16,0,0,lin,4,4,4,16,0,0,lin,12,0,8,0,0,0,lin,12,4,12,0,0,0,lin,8,4,12,4,0,0,lin,8,0,8,4,0,0,0x8c};
const int boxyRtSqBr[] = {lin,12,0,4,0,0,0,lin,12,20,12,0,0,0,lin,4,20,12,20,0,0,lin,4,16,4,20,0,0,lin,8,16,4,16,0,0,lin,8,4,8,16,0,0,lin,4,4,8,4,0,0,lin,4,0,4,4,0,0,0x8c};
const int boxyCarat[] = {lin,4,12,0,12,0,0,lin,4,16,4,12,0,0,lin,0,16,4,16,0,0,lin,0,12,0,16,0,0,lin,8,16,4,16,0,0,lin,8,20,8,16,0,0,lin,4,20,8,20,0,0,lin,4,16,4,20,0,0,lin,12,12,8,12,0,0,lin,12,16,12,12,0,0,lin,8,16,12,16,0,0,lin,8,12,8,16,0,0,0x8c};
const int boxyUnderSc[] = {lin,12,0,0,0,0,0,lin,12,4,12,0,0,0,lin,0,4,12,4,0,0,lin,0,0,0,4,0,0,0x8c};
const int boxyBackQu[] = {lin,8,16,4,16,0,0,lin,8,20,8,16,0,0,lin,4,20,8,20,0,0,lin,4,16,4,20,0,0,lin,12,12,8,12,0,0,lin,12,16,12,12,0,0,lin,8,16,12,16,0,0,lin,8,12,8,16,0,0,0x8c};
const int boxySmallA[] = {lin,4,0,0,0,0,0,lin,4,4,4,0,0,0,lin,8,4,4,4,0,0,lin,8,0,8,4,0,0,lin,12,0,8,0,0,0,lin,12,16,12,0,0,0,lin,0,16,12,16,0,0,lin,0,0,0,16,0,0,lin,4,8,8,8,0,0,lin,4,12,4,8,0,0,lin,8,12,4,12,0,0,lin,8,8,8,12,0,0,0x8c};
const int boxySmallB[] = {lin,12,0,0,0,0,0,lin,12,8,12,0,0,0,lin,8,8,12,8,0,0,lin,8,4,8,8,0,0,lin,4,4,8,4,0,0,lin,4,8,4,4,0,0,lin,8,8,4,8,0,0,lin,8,16,8,8,0,0,lin,0,16,8,16,0,0,lin,0,0,0,16,0,0,0x8c};
const int boxySmallC[] = {lin,12,0,0,0,0,0,lin,12,4,12,0,0,0,lin,4,4,12,4,0,0,lin,4,12,4,4,0,0,lin,12,12,4,12,0,0,lin,12,16,12,12,0,0,lin,0,16,12,16,0,0,lin,0,0,0,16,0,0,0x8c};
const int boxySmallD[] = {lin,8,0,0,0,0,0,lin,8,4,8,0,0,0,lin,4,4,8,4,0,0,lin,4,12,4,4,0,0,lin,8,12,4,12,0,0,lin,8,16,8,12,0,0,lin,0,16,8,16,0,0,lin,0,0,0,16,0,0,lin,12,4,8,4,0,0,lin,12,12,12,4,0,0,lin,8,12,12,12,0,0,lin,8,4,8,12,0,0,0x8c};
const int boxySmallE[] = {lin,12,0,0,0,0,0,lin,12,4,12,0,0,0,lin,4,4,12,4,0,0,lin,4,8,4,4,0,0,lin,8,8,4,8,0,0,lin,8,12,8,8,0,0,lin,12,12,8,12,0,0,lin,12,16,12,12,0,0,lin,0,16,12,16,0,0,lin,0,0,0,16,0,0,0x8c};
const int boxySmallF[] = {lin,4,0,0,0,0,0,lin,4,8,4,0,0,0,lin,8,8,4,8,0,0,lin,8,12,8,8,0,0,lin,12,12,8,12,0,0,lin,12,16,12,12,0,0,lin,0,16,12,16,0,0,lin,0,0,0,16,0,0,0x8c};
const int boxySmallG[] = {lin,12,0,0,0,0,0,lin,12,8,12,0,0,0,lin,8,8,12,8,0,0,lin,8,4,8,8,0,0,lin,4,4,8,4,0,0,lin,4,12,4,4,0,0,lin,12,12,4,12,0,0,lin,12,16,12,12,0,0,lin,0,16,12,16,0,0,lin,0,0,0,16,0,0,0x8c};
const int boxySmallH[] = {lin,4,0,0,0,0,0,lin,4,4,4,0,0,0,lin,8,4,4,4,0,0,lin,8,0,8,4,0,0,lin,12,0,8,0,0,0,lin,12,16,12,0,0,0,lin,8,16,12,16,0,0,lin,8,8,8,16,0,0,lin,4,8,8,8,0,0,lin,4,16,4,8,0,0,lin,0,16,4,16,0,0,lin,0,0,0,16,0,0,0x8c};
const int boxySmallI[] = {lin,12,0,0,0,0,0,lin,12,4,12,0,0,0,lin,8,4,12,4,0,0,lin,8,12,8,4,0,0,lin,12,12,8,12,0,0,lin,12,16,12,12,0,0,lin,0,16,12,16,0,0,lin,0,12,0,16,0,0,lin,4,12,0,12,0,0,lin,4,4,4,12,0,0,lin,0,4,4,4,0,0,lin,0,0,0,4,0,0,0x8c};
const int boxySmallJ[] = {lin,8,0,0,0,0,0,lin,8,12,8,0,0,0,lin,12,12,8,12,0,0,lin,12,16,12,12,0,0,lin,0,16,12,16,0,0,lin,0,12,0,16,0,0,lin,4,12,0,12,0,0,lin,4,4,4,12,0,0,lin,0,4,4,4,0,0,lin,0,0,0,4,0,0,0x8c};
const int boxySmallK[] = {lin,4,0,0,0,0,0,lin,4,8,4,0,0,0,lin,8,8,4,8,0,0,lin,8,12,8,8,0,0,lin,4,12,8,12,0,0,lin,4,16,4,12,0,0,lin,0,16,4,16,0,0,lin,0,0,0,16,0,0,lin,12,12,8,12,0,0,lin,12,16,12,12,0,0,lin,8,16,12,16,0,0,lin,8,12,8,16,0,0,lin,12,0,8,0,0,0,lin,12,8,12,0,0,0,lin,8,8,12,8,0,0,lin,8,0,8,8,0,0,0x8c};
const int boxySmallL[] = {lin,12,0,0,0,0,0,lin,12,4,12,0,0,0,lin,4,4,12,4,0,0,lin,4,16,4,4,0,0,lin,0,16,4,16,0,0,lin,0,0,0,16,0,0,0x8c};
const int boxySmallM[] = {lin,4,0,0,0,0,0,lin,4,8,4,0,0,0,lin,8,8,4,8,0,0,lin,8,0,8,8,0,0,lin,12,0,8,0,0,0,lin,12,16,12,0,0,0,lin,0,16,12,16,0,0,lin,0,0,0,16,0,0,0x8c};
const int boxySmallN[] = {lin,4,0,0,0,0,0,lin,4,12,4,0,0,0,lin,8,12,4,12,0,0,lin,8,16,8,12,0,0,lin,0,16,8,16,0,0,lin,0,0,0,16,0,0,lin,12,0,8,0,0,0,lin,12,12,12,0,0,0,lin,8,12,12,12,0,0,lin,8,0,8,12,0,0,0x8c};
const int boxySmallO[] = {lin,8,0,0,0,0,0,lin,8,4,8,0,0,0,lin,4,4,8,4,0,0,lin,4,12,4,4,0,0,lin,0,12,4,12,0,0,lin,0,0,0,12,0,0,lin,12,4,8,4,0,0,lin,12,16,12,4,0,0,lin,4,16,12,16,0,0,lin,4,12,4,16,0,0,lin,8,12,4,12,0,0,lin,8,4,8,12,0,0,0x8c};
const int boxySmallP[] = {lin,4,0,0,0,0,0,lin,4,4,4,0,0,0,lin,12,4,4,4,0,0,lin,12,16,12,4,0,0,lin,0,16,12,16,0,0,lin,0,0,0,16,0,0,lin,4,8,8,8,0,0,lin,4,12,4,8,0,0,lin,8,12,4,12,0,0,lin,8,8,8,12,0,0,0x8c};
const int boxySmallQ[] = {lin,12,0,4,0,0,0,lin,12,4,12,0,0,0,lin,8,4,12,4,0,0,lin,8,8,8,4,0,0,lin,4,8,8,8,0,0,lin,4,12,4,8,0,0,lin,0,12,4,12,0,0,lin,0,4,0,12,0,0,lin,4,4,0,4,0,0,lin,4,0,4,4,0,0,lin,8,12,4,12,0,0,lin,8,16,8,12,0,0,lin,4,16,8,16,0,0,lin,4,12,4,16,0,0,lin,12,8,8,8,0,0,lin,12,12,12,8,0,0,lin,8,12,12,12,0,0,lin,8,8,8,12,0,0,0x8c};
const int boxySmallR[] = {lin,4,0,0,0,0,0,lin,4,4,4,0,0,0,lin,8,4,4,4,0,0,lin,8,8,8,4,0,0,lin,4,8,8,8,0,0,lin,4,12,4,8,0,0,lin,8,12,4,12,0,0,lin,8,8,8,12,0,0,lin,12,8,8,8,0,0,lin,12,16,12,8,0,0,lin,0,16,12,16,0,0,lin,0,0,0,16,0,0,lin,12,0,8,0,0,0,lin,12,4,12,0,0,0,lin,8,4,12,4,0,0,lin,8,0,8,4,0,0,0x8c};
const int boxySmallS[] = {lin,4,8,0,8,0,0,lin,4,12,4,8,0,0,lin,0,12,4,12,0,0,lin,0,8,0,12,0,0,lin,8,0,0,0,0,0,lin,8,4,8,0,0,0,lin,0,4,8,4,0,0,lin,0,0,0,4,0,0,lin,12,12,4,12,0,0,lin,12,16,12,12,0,0,lin,4,16,12,16,0,0,lin,4,12,4,16,0,0,lin,12,4,8,4,0,0,lin,12,8,12,4,0,0,lin,8,8,12,8,0,0,lin,8,4,8,8,0,0,0x8c};
const int boxySmallT[] = {lin,8,0,4,0,0,0,lin,8,12,8,0,0,0,lin,12,12,8,12,0,0,lin,12,16,12,12,0,0,lin,0,16,12,16,0,0,lin,0,12,0,16,0,0,lin,4,12,0,12,0,0,lin,4,0,4,12,0,0,0x8c};
const int boxySmallU[] = {lin,4,4,0,4,0,0,lin,4,16,4,4,0,0,lin,0,16,4,16,0,0,lin,0,4,0,16,0,0,lin,12,0,4,0,0,0,lin,12,16,12,0,0,0,lin,8,16,12,16,0,0,lin,8,4,8,16,0,0,lin,4,4,8,4,0,0,lin,4,0,4,4,0,0,0x8c};
const int boxySmallV[] = {lin,8,0,4,0,0,0,lin,8,4,8,0,0,0,lin,12,4,8,4,0,0,lin,12,16,12,4,0,0,lin,8,16,12,16,0,0,lin,8,8,8,16,0,0,lin,4,8,8,8,0,0,lin,4,16,4,8,0,0,lin,0,16,4,16,0,0,lin,0,4,0,16,0,0,lin,4,4,0,4,0,0,lin,4,0,4,4,0,0,0x8c};
const int boxySmallW[] = {lin,12,0,0,0,0,0,lin,12,16,12,0,0,0,lin,8,16,12,16,0,0,lin,8,8,8,16,0,0,lin,4,8,8,8,0,0,lin,4,16,4,8,0,0,lin,0,16,4,16,0,0,lin,0,0,0,16,0,0,0x8c};
const int boxySmallX[] = {lin,4,12,0,12,0,0,lin,4,16,4,12,0,0,lin,0,16,4,16,0,0,lin,0,12,0,16,0,0,lin,4,0,0,0,0,0,lin,4,8,4,0,0,0,lin,0,8,4,8,0,0,lin,0,0,0,8,0,0,lin,8,8,4,8,0,0,lin,8,12,8,8,0,0,lin,4,12,8,12,0,0,lin,4,8,4,12,0,0,lin,12,12,8,12,0,0,lin,12,16,12,12,0,0,lin,8,16,12,16,0,0,lin,8,12,8,16,0,0,lin,12,0,8,0,0,0,lin,12,8,12,0,0,0,lin,8,8,12,8,0,0,lin,8,0,8,8,0,0,0x8c};
const int boxySmallY[] = {lin,12,0,0,0,0,0,lin,12,16,12,0,0,0,lin,8,16,12,16,0,0,lin,8,12,8,16,0,0,lin,4,12,8,12,0,0,lin,4,16,4,12,0,0,lin,0,16,4,16,0,0,lin,0,8,0,16,0,0,lin,8,8,0,8,0,0,lin,8,4,8,8,0,0,lin,0,4,8,4,0,0,lin,0,0,0,4,0,0,0x8c};
const int boxySmallZ[] = {lin,12,8,8,8,0,0,lin,12,16,12,8,0,0,lin,0,16,12,16,0,0,lin,0,12,0,16,0,0,lin,8,12,0,12,0,0,lin,8,8,8,12,0,0,lin,12,0,0,0,0,0,lin,12,4,12,0,0,0,lin,4,4,12,4,0,0,lin,4,8,4,4,0,0,lin,0,8,4,8,0,0,lin,0,0,0,8,0,0,0x8c};
const int boxyLfBrace[] = {lin,12,0,4,0,0,0,lin,12,4,12,0,0,0,lin,8,4,12,4,0,0,lin,8,16,8,4,0,0,lin,12,16,8,16,0,0,lin,12,20,12,16,0,0,lin,4,20,12,20,0,0,lin,4,12,4,20,0,0,lin,0,12,4,12,0,0,lin,0,8,0,12,0,0,lin,4,8,0,8,0,0,lin,4,0,4,8,0,0,0x8c};
const int boxyVertBar[] = {lin,8,0,4,0,0,0,lin,8,20,8,0,0,0,lin,4,20,8,20,0,0,lin,4,0,4,20,0,0,0x8c};
const int boxyRtBrace[] = {lin,8,0,0,0,0,0,lin,8,8,8,0,0,0,lin,12,8,8,8,0,0,lin,12,12,12,8,0,0,lin,8,12,12,12,0,0,lin,8,20,8,12,0,0,lin,0,20,8,20,0,0,lin,0,16,0,20,0,0,lin,4,16,0,16,0,0,lin,4,4,4,16,0,0,lin,0,4,4,4,0,0,lin,0,0,0,4,0,0,0x8c};
const int boxyTilde[] = {lin,4,4,0,4,0,0,lin,4,8,4,4,0,0,lin,12,8,4,8,0,0,lin,12,16,12,8,0,0,lin,8,16,12,16,0,0,lin,8,12,8,16,0,0,lin,0,12,8,12,0,0,lin,0,4,0,12,0,0,0x8c};

const int * const boxyFont[] =
{Space, boxyExclam, boxyDQuot, boxySharp, boxyDollar, boxyPercent, boxyAmper, boxyApost, boxyLParen,
 boxyRParen, boxyAster, boxyPlus, boxyComma, boxyMinus, boxyPeriod, boxySlash, boxyZero,
 boxyOne, boxyTwo, boxyThree, boxyFour, boxyFive, boxySix, boxySeven, boxyEight,
 boxyNine, boxyColon, boxySemiCol, boxyLThan, boxyEqual, boxyGThan, boxyQuest, boxyAtSign,
 boxyBigA, boxyBigB, boxyBigC, boxyBigD, boxyBigE, boxyBigF, boxyBigG, boxyBigH, 
 boxyBigI, boxyBigJ, boxyBigK, boxyBigL, boxyBigM, boxyBigN, boxyBigO, boxyBigP,
 boxyBigQ, boxyBigR, boxyBigS, boxyBigT, boxyBigU, boxyBigV, boxyBigW, boxyBigX,
 boxyBigY, boxyBigZ, boxyLftSqBr, boxyBackSl, boxyRtSqBr, boxyCarat, boxyUnderSc, boxyBackQu,
 boxySmallA, boxySmallB, boxySmallC, boxySmallD, boxySmallE, boxySmallF, boxySmallG, boxySmallH,
 boxySmallI, boxySmallJ, boxySmallK, boxySmallL, boxySmallM, boxySmallN, boxySmallO, boxySmallP,
 boxySmallQ, boxySmallR, boxySmallS, boxySmallT, boxySmallU, boxySmallV, boxySmallW, boxySmallX,
 boxySmallY, boxySmallZ, boxyLfBrace, boxyVertBar, boxyRtBrace, boxyTilde, boxyRubout};
...
const int * const * Fonts[] = {Font1, asteroidsFont, boxyFont, LEDFont};
